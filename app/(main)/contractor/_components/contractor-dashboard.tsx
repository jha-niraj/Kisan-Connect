...
import { getContractorStats, getContractorActiveBids, getContractorActiveProjects, getContractorRecentActivity } from "@/actions/(contractor)/contractor.action"
...
export default function ContractorDashboard({ session }: ContractorDashboardProps) {
