                        ...
                        {categories.map((category) => (
                          <button
                            ...
                            className={`block w-full text-left px-3 py-2 rounded-lg text-sm transition-colors ${
                              selectedCategory === category ? "bg-emerald-100 text-emerald-800" : "hover:bg-gray-100"
                            }`}
                          >
                            {category}
                          </button>
                        ...
                        <div className="relative">
                          ...
                          <button
                            ...
                            className={`absolute top-3 right-3 p-2 rounded-full ${
                              favorites.includes(product.id) ? "bg-red-100 text-red-600" : "bg-white/80 text-gray-600"
                            }`}
                          >
