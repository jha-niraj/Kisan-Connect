...
import { Sun, Moon, Equal, LogOut, LogIn, User, Package, BarChart3, Settings, ShoppingCart, Heart, Store, Tractor, ShieldCheck } from "lucide-react"
		...
		if (session?.user) {
			...
			return (
				<div className="hidden lg:flex items-center gap-4">
					...
					{/* Wishlist Icon for regular users */}
